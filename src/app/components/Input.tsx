...
export function InputControl(props: InputControlProps) {
    return (
        <input 
            className="flex-1 border-0 outline-none bg-tranparent p-0 text-zinc-900 placeholder-zinc-600 dark:placeholder-zinc-400 dark:bg-zinc-800 dark:text-zinc-100"
            {...props}
        />
    )
}
