  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="flex gap-3">
        <button
          type="button"
          className="text-sm font-medium text-violet-500 dark:text-violet-300 hover:text-violet-700 dark:hover:text-violet-100"
        >
          Dismiss
        </button>
        ...
        <button
          type="button"
          className="text-sm font-medium text-violet-700 dark:text-zinc-300 hover:text-violet-700 dark:hover:text-violet-300"
        >
          Upgrade plan
        </button>
      </div>
