...
export function Sidebar() {
    return (
        <Collapsible.Root className="flex flex-col gap-6 border-r border-zinc-200 dark:border-zinc-900 p-4 fixed left-0 top-0 right-0 z-20 bg-white dark:bg-zinc-800 data-[state=open]:bottom-0 lg:data-[state=close]:bottom-0 lg:right-auto lg:w-80 lg:border-r lg:px-5 lg:py-8>">
